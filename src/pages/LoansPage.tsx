...
import { Calendar, TrendingUp, AlertCircle, Loader2, Copy, Check, ArrowDownLeft, Banknote, CheckCircle2, Link2 } from "lucide-react";
    ...
    <MobileLayout>
      <div className="px-5 pt-12">
        ...
        >
          ...
          <h1 className="text-2xl font-bold text-foreground">Your Loans</h1>
          {publicKey && (
            <button
              onClick={copyAddress}
        ...
        {/* Bank link nudge */}
        {!demoLabel && !plaidToken && (
          <motion.button
            initial={{ opacity: 0, y: 8 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.35, delay: 0.08 }}
            onClick={() => navigate("/connect")}
            className="mb-4 flex w-full items-center gap-3 rounded-xl border border-accent/25 bg-accent/5 px-4 py-3 text-left"
          >
            <Link2 className="h-4 w-4 shrink-0 text-accent" />
            <div className="flex-1">
              <p className="text-sm font-medium text-foreground">Score is estimated</p>
              <p className="text-xs text-muted-foreground">Connect your bank to get your real score</p>
            </div>
            <span className="text-xs font-semibold text-accent">Connect →</span>
          </motion.button>
        )}
                ...
                <div className="rounded-2xl border border-avere-200 bg-avere-50 p-5 shadow-soft">
                  ...
                  <div className="mt-4">
                    <div className="mb-2 flex justify-between text-xs text-muted-foreground">
                      <span>Monthly payments made</span>
      ...
      />
            ...
            >
              ...
              <div className="flex-1">
                <p className="text-sm font-medium text-foreground">Your rate</p>
        ...
        >
          ...
          >
            ...
            <p className="text-xs text-muted-foreground">Boost your credit</p>
          </button>
        </motion.div>
